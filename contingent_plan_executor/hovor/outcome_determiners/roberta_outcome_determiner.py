...
class RobertaOutcomeDeterminer(OutcomeDeterminerBase):
    """Determiner"""
    ...
    def find_roberta_entity(self, entity: str):
        """
        **TODO: REPLACE THIS STUB**
        ...
        """
        if entity in self.roberta_entities:
            return self.roberta_entities[entity]
        ...
        **TODO: REPLACE THIS STUB**
        ...
        for extracted in entities:
            if extracted["entity"] in SPACY_LABELS:
                ...
                self.roberta_entities[extracted["entity"]] = extracted
...
can check against the regex (optional)."
    ...
    def get_raw_rankings(self, input, outcome_groups):
        ...
        r = json.loads(
            requests.post(
                "http://localhost:5006/model/parse", json={"text": input} # https://rasa.com/docs/rasa/pages/http-api#operation/parseModelMessage
            ).text
        )
